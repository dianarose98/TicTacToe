window.onload = function() {
    ...
    function checkWinner() {
        ...
        if (allblock[1].innerHTML == 'x' && allblock[5].innerHTML == 'x' && allblock[8].innerHTML == 'x') alert('Победили крестики.');
        ...
        if (allblock[1].innerHTML == '0' && allblock[5].innerHTML == '0' && allblock[8].innerHTML == '0') alert('Победили нолики.');
    }
